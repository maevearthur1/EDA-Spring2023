---
title: 'MaeveArthur_A07_CraftingReports'
author: "Maeve Arthur" 
date: "Spring 2023"
output: 
  pdf_document:
...
```{r 2018 boxplot, echo=F, fig.align='left', fig.cap="Distribution of ozone levels by month in 2018", fig.height=2.5}
plot.2018 <- epa_data %>%
  filter(Year=="2018") %>%
  ggplot(aes(
...
```{r 2019 boxplot, echo=F, fig.align='left', fig.cap="Distribution of ozone levels by month in 2019", fig.height=2.5}
plot.2019 <- epa_data %>%
  filter(Year=="2019") %>%
  ggplot(aes(
    x = factor(Month, levels=1:12, labels = month.abb), 
  ...
  geom_boxplot() +
  labs(
    title="Distribution of ozone levels by month in 2019",
    x = "Month",
    y = "Ozone level, ug") 
...
https://github.com/maevearthur1/EDA-Spring2023
