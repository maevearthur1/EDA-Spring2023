...
> Answer: The 'if' and 'else' option worked here. That is because the 'ifelse' option always returns a value, and in this case we didn't want that—we wanted the value to printed.
