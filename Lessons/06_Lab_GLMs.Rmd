...
PM.regression <- lm(EPAair$PM2.5 ~ EPAair$Ozone)
summary(PM.regression)

#p-value < 2.2e-16 - we can explain PM2.5 with ozone
#r-squared: 0.1314  - ozone only explains 13% of variability of data set
...
Ozone.All <- lm(data=epaairsubset, PM2.5~Ozone + Year + Month + mean_Lat + mean_Lng)
summary(Ozone.All)
step(Ozone.All)
...
#no point in having year because you have more variables but it is not increasing the r-squared
```
