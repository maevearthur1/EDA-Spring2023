...
> Answer: Loading the package in the console makes it available to use.
...
> ANSWER: It can be found in the data -> metadata folder. This helps with reproducabi
...
> Answer: When you want to find mean and standard deviation
