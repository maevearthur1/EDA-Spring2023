...
#Reveal the extent of this dataset via the st_bbox() function - creates spatial bounding box around all the features
st_bbox(counties_sf)
...
#Aggregate the data using group_by and summarize, just as you would a non-spatial dataframe - glom all counties into one single feature and calculate all area of NC
...
#Transform the mask to match the CRS of the counties dataset - transform to UTM
theSite_sfc_transformed <- st_transform(theSite_sfc, crs = st_crs(counties_sf_utm))

#Create a boolean mask - see what county it intersects
...
#can add more from the end of the 2nd to last video
